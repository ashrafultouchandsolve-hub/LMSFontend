...
var _c0 = (a0) => ["/quiz-editor", a0];
var _c1 = (a0) => ({ title: a0 });
var _forTrack0 = ($index, $item) => $item.key;
var _forTrack1 = ($index, $item) => $item.id;
function Teacher_For_19_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 19);
    \u0275\u0275listener("click", function Teacher_For_19_Template_button_click_0_listener() {
...
function Teacher_Conditional_23_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_24_For_34_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 29);
  }
  if (rf & 2) {
...
function Teacher_Conditional_24_For_34_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_24_For_34_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const course_r6 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("\u2B50 ", course_r6.averageRating.toFixed(1), " (", course_r6.totalRatings, ")");
  }
}
function Teacher_Conditional_24_For_34_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_24_For_34_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 28);
    \u0275\u0275conditionalCreate(3, Teacher_Conditional_24_For_34_Conditional_3_Template, 1, 2, "img", 29)(4, Teacher_Conditional_24_For_34_Conditional_4_Template, 2, 1, "div", 30);
    ...
    \u0275\u0275conditionalCreate(19, Teacher_Conditional_24_For_34_Conditional_19_Template, 2, 2, "span", 32)(20, Teacher_Conditional_24_For_34_Conditional_20_Template, 2, 0, "span", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "td")(22, "span", 34);
    \u0275\u0275text(23);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(24, "td", 35)(25, "button", 36);
    \u0275\u0275listener("click", function Teacher_Conditional_24_For_34_Template_button_click_25_listener() {
    ...
    \u0275\u0275listener("click", function Teacher_Conditional_24_For_34_Template_button_click_27_listener() {
      const course_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
    ...
    \u0275\u0275listener("click", function Teacher_Conditional_24_For_34_Template_button_click_29_listener() {
      const course_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(course_r6.totalRatings > 0 ? 19 : 20);
    \u0275\u0275advance(3);
...
function Teacher_Conditional_24_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_24_Conditional_36_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_24_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "header", 22)(1, "div")(2, "h1");
    \u0275\u0275text(3, "Courses");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p");
    ...
    \u0275\u0275listener("click", function Teacher_Conditional_24_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(7, "+ New Course");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "section", 24)(9, "input", 25);
    \u0275\u0275listener("input", function Teacher_Conditional_24_Template_input_input_9_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.updateSearchTerm($event.target.value));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 26)(11, "table")(12, "thead")(13, "tr")(14, "th");
    \u0275\u0275text(15, "Title");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275repeaterCreate(33, Teacher_Conditional_24_For_34_Template, 31, 11, "tr", null, _forTrack1);
    \u0275\u0275conditionalCreate(35, Teacher_Conditional_24_Conditional_35_Template, 3, 0, "tr");
    \u0275\u0275elementEnd()()();
    \u0275\u0275conditionalCreate(36, Teacher_Conditional_24_Conditional_36_Template, 2, 0, "p", 27);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(!ctx_r2.isLoadingCourses() && ctx_r2.filteredCourses().length === 0 ? 35 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r2.isLoadingCourses() ? 36 : -1);
  }
}
function Teacher_Conditional_25_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 27);
...
function Teacher_Conditional_25_For_13_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function Teacher_Conditional_25_For_13_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_25_For_13_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_25_For_13_Conditional_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 48);
    \u0275\u0275text(1, " Thumbnail ");
    \u0275\u0275elementEnd();
...
function Teacher_Conditional_25_For_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "article", 42)(1, "div", 44);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 45)(4, "h3");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(6, Teacher_Conditional_25_For_13_Conditional_6_Template, 2, 1, "p");
    \u0275\u0275elementStart(7, "div", 46)(8, "span");
    \u0275\u0275text(9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(12, Teacher_Conditional_25_For_13_Conditional_12_Template, 2, 0, "span", 31);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "div", 47);
    \u0275\u0275conditionalCreate(14, Teacher_Conditional_25_For_13_Conditional_14_Template, 2, 1, "a", 48);
    \u0275\u0275conditionalCreate(15, Teacher_Conditional_25_For_13_Conditional_15_Template, 2, 1, "a", 48);
    \u0275\u0275elementStart(16, "button", 37);
    \u0275\u0275listener("click", function Teacher_Conditional_25_For_13_Template_button_click_16_listener() {
    ...
    \u0275\u0275listener("click", function Teacher_Conditional_25_For_13_Template_button_click_18_listener() {
      const lesson_r9 = \u0275\u0275restoreView(_r8).$implicit;
      const ctx_r2 = \u0275\u0275nextContext(2);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(10, _c0, lesson_r9.id))("queryParams", \u0275\u0275pureFunction1(12, _c1, lesson_r9.title));
  }
}
function Teacher_Conditional_25_Conditional_14_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "header", 22)(1, "div")(2, "button", 40);
    \u0275\u0275listener("click", function Teacher_Conditional_25_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function Teacher_Conditional_25_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275conditionalCreate(11, Teacher_Conditional_25_Conditional_11_Template, 2, 0, "p", 27);
    \u0275\u0275repeaterCreate(12, Teacher_Conditional_25_For_13_Template, 22, 14, "article", 42, _forTrack1);
    \u0275\u0275conditionalCreate(14, Teacher_Conditional_25_Conditional_14_Template, 2, 0, "p", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function Teacher_Conditional_26_Conditional_50_Template(rf, ctx) {
  if (rf & 1) {
...
function Teacher_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "div", 50)(2, "div", 51)(3, "h2");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 52);
    \u0275\u0275listener("click", function Teacher_Conditional_26_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("ngSubmit", function Teacher_Conditional_26_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(26, "Level");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(27, "select", 59)(28, "option", 60);
    \u0275\u0275text(29, "Beginner");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(42, "label", 56)(43, "span");
    \u0275\u0275text(44, "Thumbnail URL");
    \u0275\u0275elementEnd();
    \u0275\u0275element(45, "input", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "label", 66)(47, "span");
    \u0275\u0275text(48, "Or Upload Thumbnail Image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "input", 67);
    \u0275\u0275listener("change", function Teacher_Conditional_26_Template_input_change_49_listener($event) {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onThumbnailSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(50, Teacher_Conditional_26_Conditional_50_Template, 2, 1, "div", 68);
    \u0275\u0275elementStart(51, "label", 69);
    \u0275\u0275element(52, "input", 70);
    \u0275\u0275elementStart(53, "span");
    \u0275\u0275text(54, "Publish course");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 71)(56, "button", 37);
    \u0275\u0275listener("click", function Teacher_Conditional_26_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeCourseModal());
    });
...
function Teacher_Conditional_27_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 68);
    \u0275\u0275element(1, "img", 83);
    \u0275\u0275elementEnd();
...
function Teacher_Conditional_27_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 50)(2, "div", 51)(3, "h2");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 52);
    \u0275\u0275listener("click", function Teacher_Conditional_27_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "form", 53);
    \u0275\u0275listener("ngSubmit", function Teacher_Conditional_27_Template_form_ngSubmit_7_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.saveLesson());
    });
    \u0275\u0275elementStart(8, "label", 56)(9, "span");
    \u0275\u0275text(10, "Lesson Title *");
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "input", 54);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "label", 56)(13, "span");
    \u0275\u0275text(14, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(15, "textarea", 57);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275element(29, "input", 78);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "label", 56)(31, "span");
    \u0275\u0275text(32, "Video URL");
    \u0275\u0275elementEnd();
    \u0275\u0275element(33, "input", 79);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(34, "label", 66)(35, "span");
    \u0275\u0275text(36, "Or Upload Video File");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(37, "input", 80);
    \u0275\u0275listener("change", function Teacher_Conditional_27_Template_input_change_37_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onLessonVideoFileSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(38, "label", 66)(39, "span");
    \u0275\u0275text(40, "Lesson Thumbnail (optional)");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(41, "input", 67);
    \u0275\u0275listener("change", function Teacher_Conditional_27_Template_input_change_41_listener($event) {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onLessonThumbnailSelected($event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(42, Teacher_Conditional_27_Conditional_42_Template, 2, 1, "div", 68);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(51, "label", 69);
    \u0275\u0275element(52, "input", 82);
    \u0275\u0275elementStart(53, "span");
    \u0275\u0275text(54, "Free preview lesson");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(55, "div", 71)(56, "button", 37);
    \u0275\u0275listener("click", function Teacher_Conditional_27_Template_button_click_56_listener() {
      \u0275\u0275restoreView(_r11);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.closeLessonModal());
    });
...
var Teacher = class _Teacher {
  ...
  onThumbnailError(event, context) {
  ...
  async loadTeacherCourses() {
    ...
    try {
      ...
      const mapped = await Promise.all(courseDtos.map(async (course) => {
        ...
        const ratingData = ratingSummaryRes?.data ?? ratingSummaryRes?.Data ?? null;
        ...
        return this.mapCourse(course, existingLessonsByCourseId.get(course.id) ?? [], countRes.totalEnrollment, averageRating, totalRatings);
      }));
  ...
  async loadLessons(courseId) {
    ...
    try {
      ...
      const lessonArray = Array.isArray(anyRes?.data) ? anyRes.data : Array.isArray(anyRes?.Data) ? anyRes.Data : [];
      const lessons = lessonArray.map((lesson) => this.mapLesson(lesson));
  ...
  mapCourse(dto, existingLessons = [], studentCount = 0, averageRating = 0, totalRatings = 0) {
    return {
      id: dto.id,
      title: dto.title,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Teacher, selectors: [["app-teacher"]], decls: 28, vars: 4, consts: [[1, "teacher-root"], [1, "top-navbar", "top-navbar--teacher"], ["routerLink", "/homepage", 1, "brand"], ["src", "/Logo2.png", "alt", "Touch & Solve", 1, "brand-logo"], [1, "topbar-nav"], ["routerLink", "/homepage"], ["routerLink", "/courses"], [1, "topbar-actions"], ["type", "button", "routerLink", "/home-page", 1, "nav-button", "nav-button-ghost"], [1, "teacher-page"], ["aria-label", "Teacher dashboard navigation", 1, "sidebar"], [1, "sidebar-head"], [1, "sidebar-nav"], ["type", "button", 1, "side-link", 3, "active"], ["type", "button", 1, "back-site", 3, "click"], [1, "dashboard-area"], [1, "notice", 3, "notice-error"], ["role", "dialog", "aria-modal", "true", "aria-label", "Course editor dialog", 1, "modal-backdrop"], ["role", "dialog", "aria-modal", "true", "aria-label", "Lesson editor dialog", 1, "modal-backdrop"], ["type", "button", 1, "side-link", 3, "click"], [1, "icon"], [1, "notice"], [1, "toolbar"], ["type", "button", 1, "btn", "btn-primary", 3, "click"], ["aria-label", "Course list", 1, "panel"], ["type", "search", "placeholder", "Search courses...", 1, "search-input", 3, "input", "value"], [1, "table-wrap"], [1, "loading-text"], [1, "course-title-cell"], [1, "thumb", 3, "src", "alt"], [1, "thumb", "placeholder"], [1, "chip"], [1, "rating-pill"], [1, "rating-pill", "rating-pill-empty"], [1, "status"], [1, "actions-cell"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "button", 1, "btn", "btn-ghost", 3, "click"], ["type", "button", 1, "btn", "btn-danger", 3, "click"], ["colspan", "9", 1, "empty-state"], ["type", "button", 1, "link-btn", 3, "click"], ["aria-label", "Lesson list", 1, "panel", "lesson-list"], [1, "lesson-item"], [1, "empty-state"], [1, "lesson-order"], [1, "lesson-content"], [1, "lesson-meta"], [1, "lesson-actions"], ["target", "_blank", "rel", "noopener noreferrer", 1, "btn", "btn-outline", 3, "href"], [1, "btn", "btn-quiz", 3, "routerLink", "queryParams"], [1, "modal-card"], [1, "modal-head"], ["type", "button", 1, "icon-btn", 3, "click"], [1, "form-grid", 3, "ngSubmit", "formGroup"], ["type", "text", "formControlName", "title"], ["type", "text", "formControlName", "category"], [1, "full"], ["rows", "3", "formControlName", "description"], ["type", "text", "formControlName", "instructorName"], ["formControlName", "level"], ["value", "Beginner"], ["value", "Intermediate"], ["value", "Advanced"], ["type", "number", "formControlName", "price"], ["type", "number", "formControlName", "durationMinutes"], ["type", "url", "formControlName", "thumbnailUrl", "placeholder", "https://example.com/thumbnail.jpg"], [1, "full", "upload-field"], ["type", "file", "accept", "image/*", 3, "change"], [1, "full", "preview-wrap"], [1, "checkbox", "full"], ["type", "checkbox", "formControlName", "published"], [1, "modal-actions", "full"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["alt", "Selected thumbnail preview", 1, "thumb-preview", 3, "src"], ["formControlName", "videoType"], ["value", "YouTube"], ["value", "Vimeo"], ["value", "Direct URL"], ["type", "number", "formControlName", "orderIndex"], ["type", "url", "formControlName", "videoUrl", "placeholder", "https://www.youtube.com/watch?v=..."], ["type", "file", "accept", "video/*", 3, "change"], ["type", "url", "formControlName", "resourceUrl"], ["type", "checkbox", "formControlName", "isPreview"], ["alt", "Selected lesson thumbnail preview", 1, "thumb-preview", 3, "src"]], template: function Teacher_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(12, "main", 9)(13, "aside", 10)(14, "div", 11)(15, "h2");
      \u0275\u0275text(16, "\u2699 Admin Panel");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(17, "nav", 12);
      \u0275\u0275repeaterCreate(18, Teacher_For_19_Template, 5, 4, "button", 13, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(20, "button", 14);
      \u0275\u0275listener("click", function Teacher_Template_button_click_20_listener() {
        return ctx.goToHome();
      });
      \u0275\u0275text(21, "\u2190 Back to Site");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "section", 15);
      \u0275\u0275conditionalCreate(23, Teacher_Conditional_23_Template, 2, 3, "div", 16);
      \u0275\u0275conditionalCreate(24, Teacher_Conditional_24_Template, 37, 3)(25, Teacher_Conditional_25_Template, 15, 3);
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(26, Teacher_Conditional_26_Template, 60, 4, "div", 17);
      \u0275\u0275conditionalCreate(27, Teacher_Conditional_27_Template, 60, 4, "div", 18);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      \u0275\u0275advance(18);
            ...
            <tbody>\r
              @for (course of filteredCourses(); track course.id) {\r
                <tr>\r
                  ...
                  <td>\r
                    @if (course.totalRatings > 0) {\r
                      <span class="rating-pill">\u2B50 {{ course.averageRating.toFixed(1) }} ({{ course.totalRatings }})</span>\r
                    } @else {\r
                      <span class="rating-pill rating-pill-empty">No ratings</span>\r
                    }\r
                  </td>\r
                  <td>\r
...
\r
              @if (!isLoadingCourses() && filteredCourses().length === 0) {\r
                <tr>\r
                  <td colspan="9" class="empty-state">No course found.</td>\r
                </tr>\r
              }\r
            </tbody>\r
          </table>\r
...
\r
                 <a [routerLink]="['/quiz-editor', lesson.id]" [queryParams]="{ title: lesson.title }" class="btn btn-quiz">Add Quiz</a>\r
            </div>\r
          </article>\r
        }\r
\r
