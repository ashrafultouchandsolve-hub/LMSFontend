...
const EN: Translations = {
  ...
  cdNoteText: 'Demo/video content is not available.', cdSeeLess: 'See less', cdSeeMore: 'See more',
...
const BN: Translations = {
  ...
  cdNoteText: 'ডেমো/ভিডিও কনটেন্ট এখনো পাওয়া যাচ্ছে না।', cdSeeLess: 'কম দেখুন', cdSeeMore: 'আরো দেখুন',
